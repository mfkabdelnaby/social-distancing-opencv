...
class CentroidTracker:
	...
	def register(self, centroid, rect):
        ...
        # When an ID is reqgistered, stored its bounding box
		self.rectID[self.nextObjectID] = rect
	...
	def update(self, rects):
		...
		# centroids
			...
			objectCentRects = list(self.objects.values())
			objectCentroids = [x[0] for x in objectCentRects]
